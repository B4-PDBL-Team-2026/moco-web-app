...
export default function DeleteAccountInformation() {
    const steps = [
        'Buka aplikasi email favorit kamu.',
        'Kirim email ke moco.web.app@gmail.com dengan subjek "Permintaan Hapus Akun".',
        'Jangan lupa tulis email yang kamu pakai di aplikasi Moco, ya!',
        'Beres! Tim kami bakal bantu hapus semua data dan akunmu dalam waktu maksimal 1x24 jam.',
    ];
    ...
    return (
        <div className="flex min-h-screen flex-col items-center bg-gray-100 pt-6 sm:justify-center sm:pt-0">
            ...
            {/* Logo — identical to ResetPassword & EmailVerification */}
            ...
            <div className="mt-6 w-full overflow-hidden rounded-2xl border border-gray-100 bg-white p-8 shadow-md sm:max-w-lg">
                ...
                <p className="mb-6 text-center text-gray-500">
                    Cara Menghapus Akun dan Data Moco Kamu
                </p>

                {/* Warning banner */}
                <div className="mb-6 rounded-lg bg-red-100 p-4 text-sm text-red-700">
                    Tindakan ini permanen, lho. Kalau lanjut, semua data transaksi, atur-atur anggaran, dan riwayat keuanganmu bakal <strong>dihapus dan nggak bisa balik lagi</strong>. Yakin mau pamit?
                </div>
                ...
                <ol className="space-y-4">
                    {steps.map((step, index) => (
                        <li key={index} className="flex items-start gap-4">
                            ...
                            {/* Step text — highlight the email address and subject */}
                            <p
                                className="text-gray-700"
                                dangerouslySetInnerHTML={{
                                    __html: step
                                        .replace(
                                            'admin@moco-app.web.id',
                                            '<a href="mailto:admin@moco-app.web.id" class="font-medium text-primary underline underline-offset-2">admin@moco-app.web.id</a>',
                                        )
                                        .replace(
                                            '"Permintaan Hapus Akun"',
                                            '<span class="font-medium text-gray-900">"Permintaan Hapus Akun"</span>',
                                        ),
                                }}
                            />
                        </li>
                ...
                <p className="text-center text-sm text-gray-400">
                    Butuh bantuan?{' '}
                    <a
                        href="mailto:moco.web.app@gmail.com"
