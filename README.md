...
## Developer Notes
Panduan Developer: Standar Koding & Arsitektur
Dokumen ini adalah aturan main wajib buat siapa pun yang mau push kode ke repositori ini. Gue udah buatin Skeleton Files, tugas lu cuma ngisi isinya tanpa ngerusak struktur yang ada.

1. Aturan Emas: Bahasa Inggris & Penamaan
English Only in Code: Nama variable, method, class, dan KOMENTAR wajib pake Bahasa Inggris. Nggak boleh ada // hitung total saldo atau $variabelKosong. Pake // calculate total balance atau $emptyVariable.

Pengecualian: Isi data di database (seeder/metadata) boleh Bahasa Indonesia (misal: name => 'Bayar Kosan').
